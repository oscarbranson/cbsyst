...
from cbsyst.MyAMI_V2 import MyAMI_Fcorr, MyAMI_K_calc
from cbsyst import MyAMI
from cbsyst import calc_Ks
...
#         CaMgParams = [
#                 (None, None, MyAMI_orig),
#                 (0.01, 0.01, MyAMI_lowMgnormCa),
#                 (0.01, 0.1, MyAMI_highMgnormCa),
#                 (0.005, 0.05, MyAMI_normMglowCa),
#                 (0.05, 0.05, MyAMI_normMghighCa),
#                 (0.05, 0.1, MyAMI_highMghighCa),
#                 (0.005, 0.01, MyAMI_lowMglowCa)
#             ]

#         for Mg, Ca, params in CaMgParams:
#             oKs = MyAMI_K_calc(param_dict=params)
#             Ks = calc_Ks(T=25, S=35, P=0, Ca=Ca, Mg=Mg)
#             for k in oKs:
#                 self.assertAlmostEqual(oKs[k] / Ks[k], 1, msg=f"{k}, Ca={Ca}, Mg={Mg}", places=2)
