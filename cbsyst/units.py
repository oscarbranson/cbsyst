...
CONCENTRATION_PARAMS = ["DIC", "TA", "CO2", "HCO3", "CO3", "BT", "PT", "SiT"]
...
def convert_to_molar(params: CarbonSystemParams) -> None:
...
def convert_from_molar(params: CarbonSystemParams) -> None:
    ...
    for param in GAS_PARAMS:
        if param in params:
            params[param] = np.multiply(params[param], 1e6)